Gem::Specification.new do |s|
  ...
  s.files = ["lib/ohm/collection.rb", "lib/ohm/compat-1.8.6.rb", "lib/ohm/key.rb", "lib/ohm/validations.rb", "lib/ohm.rb", "README.markdown", "LICENSE", "Rakefile", "test/1.8.6_test.rb", "test/all_tests.rb", "test/benchmarks.rb", "test/circular_reference_test.rb", "test/connection_test.rb", "test/errors_test.rb", "test/indices_test.rb", "test/model_test.rb", "test/mutex_test.rb", "test/test_helper.rb", "test/validations_test.rb", "test/wrapper_test.rb", "test/test.conf"]
